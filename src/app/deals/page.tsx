...
const dealProducts = products
  ...
  .map((product, index) => ({
    ...
    dealEndTime: new Date(Date.now() + (index + 1) * 24 * 60 * 60 * 1000), // 1-7 days from now based on index
    isFlashDeal: index % 3 === 0, // Every third product is a flash deal
    stockLeft: 15 - (index % 10), // Stock between 5-15 based on index
  }))
  .sort((a, b) => {
