...
export function FeaturedProducts() {
  ...
  const handleWishlistToggle = (product: typeof products[0], event: React.MouseEvent<HTMLButtonElement>) => {
  ...
  return (
    <section className="py-24 bg-white relative overflow-hidden">
      ...
      <div className="absolute inset-0 pointer-events-none">
        ...
        <div className="absolute bottom-10 right-1/4 w-48 h-48 bg-gradient-to-r from-purple-400/10 to-blue-400/10 rounded-full blur-3xl animate-pulse delay-1000" />
        <div className="absolute top-1/3 right-10 w-32 h-32 bg-gradient-to-r from-green-400/10 to-blue-400/10 rounded-full blur-2xl animate-pulse delay-500" />
      </div>
